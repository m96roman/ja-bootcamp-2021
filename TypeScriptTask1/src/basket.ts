...
const AddToBasket = (id:string) => {
    ...
    let basketProducts:Array<productDetails> = [];
    
    let prodId: string = id;
    ...
    data.productList.find((element:productDetails) => {
    ...
    if (basketData === null) {
        ...
        basketData.basketProducts.forEach((element: productDetails) => {
            basketProducts.push(element);
        });
        storageBasketItems = { basketProducts };
    };
...
const AppendToBasket = () => {
    ...
    data.basketProducts.forEach((element: productDetails) => {
